...
Usage:
    jop.py
    jop.py [-h | --help]
    jop.py [-s START -e END --strokes STROKES --popsize POPSIZE --generations GENERATIONS --fit PERCENT --lucky PERCENT]
...
Options:
    ...
    --popsize <popsize>  Size of the population [default: 1000]
    --fit <percent>      Percentage (decimal) to select [default: .2]
    --lucky <percent>    Additional percentage to select by luck [default: .05]
'''
...
def happy_little_accidents(
    ...
    fit_percentage=.02, lucky_percentage=.05
):
    '''
    ...
    for image in pruned_gallery:
        ...
        world = genetics.GeneticPainting(
            ...
            fit_percentage=fit_percentage, lucky_percentage=lucky_percentage,
        )
